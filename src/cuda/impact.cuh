...
struct g_impact {
    ...
    __host__ __device__ g_impact (ImpactType type, uint n0, uint n1, uint n2, uint n3, bool f0, bool f1, bool f2, bool f3)
	{
		_type = type;
...
inline __device__ void addImpact(g_impact *imps, uint *idx, g_impact &imp)
{
