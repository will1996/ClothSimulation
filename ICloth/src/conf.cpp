...
void parse (REAL&, const Json::Value&);
...
void load_json (const string &configFilename, Simulation &sim) {
    ...
    parse(sim.friction, json["friction"], REAL(0.6));
    parse(sim.obs_friction, json["obs_friction"], REAL(0.3));
...
void parse (REAL &x, const Json::Value &json) {
...
void parse (Transformation& transform, const Json::Value &json) {
    ...
    parse(transform.scale, json["scale"], REAL(1.));
...
void parse (Cloth::Material *&mat, const Json::Value &json) {
    ...
    parse(material->damping, json["damping"], REAL(0.));
    ...
    parse(material->weakening, json["weakening"], REAL(0.));
}
...
void parse_handle (vector<Handle*> &hans, const Json::Value &json,
    ...
    parse(start_time, json["start_time"], REAL(0.));
    parse(end_time, json["end_time"], infinity);
    parse(fade_time, json["fade_time"], REAL(0.));
...
void parse_obstacle (Obstacle &obstacle, const Json::Value &json,
    ...
    parse(obstacle.start_time, json["start_time"], REAL(0.));
...
void parse (Wind &wind, const Json::Value &json) {
    parse(wind.density, json["density"], REAL(1.));
    parse(wind.velocity, json["velocity"], Vec3(0));
    parse(wind.drag, json["drag"], REAL(0.));
}
