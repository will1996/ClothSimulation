...
// aa: if defined, AVX SIMD REALs will be used for vector math.
//#define _AVX
...
template <int n, typename T=REAL> class Vec {
private:
#if defined(_AVX)
...
#include <x86intrin.h>
#endif
template<> inline Vec<3,REAL> operator+<3,REAL>(const Vec<3,REAL> &u, const Vec<3,REAL> &v) { __m256d r = _mm256_add_pd((__m256d&)u, (__m256d&)v); return (Vec<3,REAL>&)r; }
template<> inline Vec<3,REAL> operator-<3,REAL>(const Vec<3,REAL> &u, const Vec<3,REAL> &v) { __m256d r = _mm256_sub_pd((__m256d&)u, (__m256d&)v); return (Vec<3,REAL>&)r; }
template<> inline Vec<3,REAL> operator*<3,REAL>(const REAL &a, const Vec<3,REAL> &v) { __m256d r = _mm256_mul_pd(_mm256_set1_pd(a), (__m256d&)v); return (Vec<3,REAL>&)r; }
template<> inline Vec<3,REAL> operator/<3,REAL>(const Vec<3,REAL> &u, const REAL &a) { __m256d r = _mm256_div_pd((__m256d&)u, _mm256_set1_pd(a)); return (Vec<3,REAL>&)r; }

template<> inline Vec<3,REAL>& operator+=<3,REAL>(Vec<3,REAL> &r, const Vec<3,REAL> &v) { (__m256d&)r = _mm256_add_pd((__m256d&)r, (__m256d&)v); return r; }
template<> inline Vec<3,REAL>& operator-=<3,REAL>(Vec<3,REAL> &r, const Vec<3,REAL> &v) { (__m256d&)r = _mm256_sub_pd((__m256d&)r, (__m256d&)v); return r; }

// There are no base templates for these functions, we will define inline versions.
inline Vec<3,REAL>& operator*=(Vec<3,REAL> &r, const Vec<3,REAL> &v)      { (__m256d&)r = _mm256_mul_pd((__m256d&)r, (__m256d&)v); return r; }
inline Vec<3,REAL>& operator/=(Vec<3,REAL> &r, const Vec<3,REAL> &v)      { (__m256d&)r = _mm256_div_pd((__m256d&)r, (__m256d&)v); return r; }
inline Vec<3,REAL>  operator*(const Vec<3,REAL> &u, const Vec<3,REAL> &v) { __m256d r = _mm256_mul_pd((__m256d&)u, (__m256d&)v); return (Vec<3,REAL>&)r; }
inline Vec<3,REAL>  operator/(const Vec<3,REAL> &u, const Vec<3,REAL> &v) { __m256d r = _mm256_div_pd((__m256d&)u, (__m256d&)v); return (Vec<3,REAL>&)r; }
#endif
...
template <int m, int n, typename T=REAL> class MatTransposed;

template <int m, int n, typename T=REAL> class Mat {
private:
    VecmT c[n];
public:
